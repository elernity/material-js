...
class DraggableGridViewCustom extends Component {
        ...
        return (
            <View
                ...
                onLayout={(e) => {
                    ...
                    console.log(`the distance between top of DraggableGridViewCustom and ScrollView is ${this.topRelativeToScrollView}`);
                }}>
...
export default withTheme(DraggableGridViewCustom);
